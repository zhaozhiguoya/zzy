...
<section>
<div class="dirbox">
	<span>子菜单管理&nbsp;&nbsp;>&nbsp;&nbsp;查看菜单</span>
</div>
<div class="tablebox">
	<form action="SubmenuServlet?flag=findByName" method="post" class="findbox">
	<a href="SubmenuServlet?flag=findMenu" style="background-color: green;font-size: 22px;margin-left: 12px;float: left;">+&nbsp;增加</a>
...
<table>
		<tr>
			...
			<td width="100">提交者编号</td>
			<td width="200">操作</td>
		</tr>
		<c:forEach  items="${submenu }" var="ul">
			<tr>
			<td><input type="checkbox" name="check" id="c${ul.id }"/></td>
				...
				<td>${ul.uid }</td>
				 <td>
				 <div class="btn-delete"><a href="SubmenuServlet?flag=delete&id=${ul.id }">
      			 <img src="${pageContext.request.contextPath}/img/btn-delete.png"/>删除</a></div>
         		 <div class="btn-edit" id="${ul.id }"><a href="SubmenuServlet?flag=yupdate&id=${ul.id }">
