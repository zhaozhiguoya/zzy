...
<section>
<div class="dirbox">
	<span>子菜单管理&nbsp;&nbsp;>&nbsp;&nbsp;修改菜单</span>
</div>
		<form action="SubmenuServlet?flag=update&uid=${smenu.uid }&id=${smenu.id}" method="post">
		<input type="text" placeholder="${smenu.title }" name="title" required id="title" style="width: 240px;height: 35px;"/><br/><br/> 
			<select id="s_menu" name="select">
				<option value="${smenu.id }">${smenu.title }</option>
           	...
           	<br><br>
           	<textarea id="content" name="content" style="width: 700px;height: 200px;">${smenu.content }</textarea>
           	<br><br>
